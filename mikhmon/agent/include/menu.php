...
<?php if ($hotspot == "dashboard") { ?>
    <li>
        <a href="./whatsapp" title="WhatsApp Gateway">
            <i class="fa fa-whatsapp"></i> WhatsApp Gateway
        </a>
    </li>
    <div class="dropdown-btn"><i class="fa fa-users"></i> Manajemen Agen
        <i class="fa fa-caret-down"></i>
    </div>
    <div class="dropdown-container">
        <a href="./whatsapp/admin_agent.php" class="menu">
            <i class="fa fa-user-plus"></i> Daftar Agen
        </a>
        <a href="./whatsapp/transactions.php" class="menu">
            <i class="fa fa-money"></i> Transaksi Agen
        </a>
    </div>
<?php } ?>
